...
export function TitleBar() {
    ...
    return (
        <div className="drag-region relative z-40 flex h-10 w-full items-center justify-between bg-gradient-to-r from-slate-950 via-indigo-900 to-slate-800 px-4 text-[0.7rem] font-medium uppercase tracking-[0.35em] text-slate-200 shadow-md">
