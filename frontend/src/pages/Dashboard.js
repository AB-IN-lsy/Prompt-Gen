...
function MetricCard({ icon: Icon, label, value, delta, trend }) {
    return (_jsxs(GlassCard, { className: "relative overflow-hidden", children: [_jsxs("div", { className: "flex items-start justify-between gap-4", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm text-slate-500", children: label }), _jsx("p", { className: "mt-3 text-3xl font-semibold text-slate-900", children: value })] }), _jsx("div", { className: "rounded-2xl bg-primary/10 p-3 text-primary shadow-glow", children: _jsx(Icon, { className: "h-6 w-6", "aria-hidden": "true" }) })] }), _jsx("p", { className: "mt-4 text-xs font-medium " +
...
export default function DashboardPage() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between", children: [_jsxs("div", { className: "space-y-2", children: [_jsx(Badge, { className: "w-fit", variant: "outline", children: t("dashboard.title") }), _jsx("h1", { className: "text-3xl font-semibold text-slate-900 sm:text-4xl", children: t("dashboard.welcome", { name: displayName }) }), _jsx("p", { className: "text-sm text-slate-500 sm:text-base", children: t("dashboard.subtitle") })] }), _jsxs("div", { className: "flex flex-wrap gap-3", children: [_jsxs(Button, { variant: "secondary", size: "lg", onClick: () => navigate("/prompt-workbench"), className: "gap-2", children: [_jsx(Sparkles, { className: "h-4 w-4", "aria-hidden": "true" }), t("dashboard.openWorkbench")] }), _jsxs(Button, { variant: "outline", size: "lg", onClick: () => navigate("/prompt-workbench?tab=create"), className: "gap-2", children: [_jsx(ArrowUpRight, { className: "h-4 w-4", "aria-hidden": "true" }), t("dashboard.createPrompt")] })] })] }), _jsx("div", { className: "grid gap-4 md:grid-cols-2 xl:grid-cols-3", children: metrics.map((metric) => (_jsx(MetricCard, { ...metric }, metric.id))) }), _jsxs("div", { className: "grid gap-4 xl:grid-cols-5", children: [_jsxs(GlassCard, { className: "xl:col-span-3", children: [_jsxs("div", { className: "flex items-center justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-lg font-semibold text-slate-900", children: t("dashboard.activity.title") }), _jsx("p", { className: "mt-1 text-sm text-slate-500", children: t("dashboard.subtitle") })] }), _jsxs(Badge, { variant: "outline", className: "gap-1 text-xs", children: [_jsx(Clock, { className: "h-3.5 w-3.5", "aria-hidden": "true" }), t("common.loading")] })] }), _jsx("div", { className: "mt-6 space-y-4", children: activity.length === 0 ? (_jsx("p", { className: "text-sm text-slate-500", children: t("dashboard.activity.empty") })) : (activity.map((item) => (_jsxs("div", { className: "flex items-start gap-3", children: [_jsx("div", { className: "mt-1 h-2.5 w-2.5 rounded-full bg-gradient-to-br from-primary to-secondary" }), _jsxs("div", { className: "grow space-y-1", children: [_jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [_jsx("span", { className: "text-xs font-medium uppercase tracking-wide text-slate-400", children: item.time }), _jsx("span", { className: "text-sm " +
                                                                (item.tone === "positive"
                                                                    ? "text-slate-900"
                                                                    : "text-slate-600"), children: item.label })] }), item.note ? (_jsx("span", { className: "text-xs text-slate-500", children: item.note })) : null] })] }, item.id)))) })] }), _jsxs(GlassCard, { className: "xl:col-span-2", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h2", { className: "text-lg font-semibold text-slate-900", children: t("dashboard.performance.title") }), _jsxs(Button, { variant: "ghost", size: "sm", className: "gap-2 text-xs", onClick: () => navigate("/prompts"), children: [t("dashboard.performance.cta"), _jsx(ArrowUpRight, { className: "h-3 w-3", "aria-hidden": "true" })] })] }), _jsx("div", { className: "mt-5 overflow-hidden rounded-2xl border border-white/60", children: _jsxs("table", { className: "min-w-full divide-y divide-white/60", children: [_jsx("thead", { className: "bg-white/30 text-left text-xs uppercase tracking-wide text-slate-500", children: _jsxs("tr", { children: [_jsx("th", { className: "px-4 py-3 font-medium", children: t("dashboard.performance.columns.prompt") }), _jsx("th", { className: "px-4 py-3 font-medium", children: t("dashboard.performance.columns.model") }), _jsx("th", { className: "px-4 py-3 font-medium text-right", children: t("dashboard.performance.columns.conversion") })] }) }), _jsx("tbody", { className: "divide-y divide-white/50 text-sm text-slate-700", children: promptPerformance.map((row) => (_jsxs("tr", { children: [_jsxs("td", { className: "px-4 py-3", children: [_jsx("div", { className: "font-medium text-slate-900", children: row.title }), _jsx("div", { className: "text-xs text-slate-500", children: row.movement })] }), _jsx("td", { className: "px-4 py-3 text-slate-600", children: row.model }), _jsx("td", { className: "px-4 py-3 text-right", children: _jsx("span", { className: "font-semibold " +
                                                                (row.improving ? "text-emerald-600" : "text-rose-500"), children: row.conversion }) })] }, row.id))) })] }) })] })] }), _jsxs("div", { className: "grid gap-4 lg:grid-cols-2", children: [_jsxs(GlassCard, { children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h2", { className: "text-lg font-semibold text-slate-900", children: t("dashboard.insights.title") }), _jsx(TrendingUp, { className: "h-5 w-5 text-primary", "aria-hidden": "true" })] }), _jsx("p", { className: "mt-1 text-sm text-slate-500", children: t("dashboard.insights.subtitle") }), _jsx("div", { className: "mt-5 space-y-3", children: keywordInsights.map((insight) => (_jsxs("div", { className: "flex items-center justify-between rounded-2xl bg-white/60 px-4 py-3", children: [_jsx("span", { className: "text-sm font-medium text-slate-700", children: insight.keyword }), _jsx(Badge, { className: "bg-emerald-50 text-emerald-600", children: insight.lift })] }, insight.id))) })] }), _jsxs(GlassCard, { className: "relative overflow-hidden", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h2", { className: "text-lg font-semibold text-slate-900", children: t("dashboard.metrics.successRate") }), _jsx("div", { className: "rounded-full bg-primary/10 p-3 text-primary", children: _jsx(TrendingUp, { className: "h-5 w-5", "aria-hidden": "true" }) })] }), _jsx("p", { className: "mt-1 text-sm text-slate-500", children: t("dashboard.trend.up", { value: "4%" }) }), _jsx("div", { className: "mt-6 space-y-4", children: [68, 72, 74].map((value, index) => (_jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex items-center justify-between text-xs text-slate-500", children: [_jsxs("span", { children: ["Week ", index + 1] }), _jsxs("span", { children: [value, "%"] })] }), _jsx("div", { className: "h-2 overflow-hidden rounded-full bg-white/60", children: _jsx("div", { className: "h-full rounded-full bg-gradient-to-r from-primary to-secondary", style: { width: `${value}%` } }) })] }, value))) })] })] })] }));
}
