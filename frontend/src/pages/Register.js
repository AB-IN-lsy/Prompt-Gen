...
export default function RegisterPage() {
    ...
    return (_jsxs(AuthLayout, { title: t("auth.register.title") ?? "", subtitle: t("auth.register.subtitle") ?? undefined, children: [_jsxs("form", { className: "space-y-5", onSubmit: handleSubmit, children: [_jsxs("div", { className: "space-y-2", children: [_jsx("label", { className: "text-sm font-medium text-slate-700", htmlFor: "username", children: t("auth.form.username") }), _jsx(Input, { id: "username", autoComplete: "username", required: true, value: form.username, onChange: (event) => {
                                ...
                                }, placeholder: t("auth.captcha.placeholder") ?? "" }), fieldErrors.captcha_code ? (_jsx("p", { className: "text-xs text-red-500", children: fieldErrors.captcha_code })) : null] }), errorMessage ? _jsx("p", { className: "text-sm text-red-500", children: errorMessage }) : null, _jsx(Button, { type: "submit", className: "w-full", disabled: isSubmitDisabled, children: mutation.isPending ? t("common.loading") : t("auth.register.cta") })] }), _jsxs("div", { className: "text-center text-sm text-slate-500", children: [t("auth.register.switch"), " ", " ", _jsx(Link, { to: "/login", className: "font-medium text-primary hover:underline", children: t("auth.register.switchCta") })] })] }));
}
